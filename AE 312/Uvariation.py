...
plt.plot(x_values, U_plot_values, 'ro')
m,c = np.polyfit(x_values, U_plot_values, 1)
...
plt.xticks([])
plt.yticks([])
plt.title("Variation of Centerline Velocity with distance from the nozzle")
plt.savefig("U.png")
plt.show()
